  ...
  createDb() {
    ...
    const skills = [
      ...
      <path fill="#FFFFFF" d="M239.51,173.693"/>
        ...
        imgType: 'htmlSvg',
        description: `
        <h1 style="margin: auto">OVER 15 YEARS EXPERIENCE.*</h1>
        <p style="line-height:1">Used at:</p>
        <ul style="text-align:left;list-style: circle;padding: 10px;">
        <li>Quidco</li>
        <li>Pulselive</li>
        <li>The Workshop</li>
        <li>This website & other personal projects</li>
        </ul>`
      },
      {
        name: 'AngularJS (1 & 2)',
      ...
      },
      {
        ...
        imgType: 'htmlSvg',
        description: `
        <h1 style="margin: auto">OVER 2 YEARS EXPERIENCE.</h1>
        <p style="line-height:1">Used at:</p>
        <ul style="text-align:left;list-style: circle;padding: 10px;">
        <li>Quidco</li>
      ...
      },
      {
        ...
        description: `
        <h1 style="margin: auto">OVER 8 YEARS EXPERIENCE.</h1>
        <p style="line-height:1">Used at:</p>
        <ul style="text-align:left;list-style: circle;padding: 10px;">
        <li>Quidco</li>
        <li>Pulselive</li>
